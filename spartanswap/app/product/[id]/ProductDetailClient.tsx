...
const copyEmailToClipboard = () => {
        ...
        <div className="bg-white/50 p-6 rounded-lg shadow-lg flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 mt-8 sm:mt-0 sm:ml-8 flex flex-col space-y-4">
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white px-3 py-3 rounded-lg font-semibold hover:bg-blue-700 transition"
            >
              Contact Seller
            </button>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-md shadow-lg max-w-md w-full text-gray-800">
      ...
      <p className="mt-2"><strong>Phone:</strong> {sellerPhone || "Not provided"}</p>
